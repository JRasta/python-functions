...
button_equal = Button(root, text='=', padx=182, pady=20, command=button_equal)
...
button_multiply = Button(root, text='*', padx=41.5, pady=20, command=button_multiply)
button_divide = Button(root, text='/', padx=41.5, pady=20, command=button_divide)

# add buttons to root widget
